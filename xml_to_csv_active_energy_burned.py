...
from healthdata import HK_REC_TYPE_ActiveEnergyBurned
from xml_to_csv_argparser import parse_cmdline
from xml_to_csv_record import  xml_to_csv

from apple_health_xml_to_csv import AppleHealthActiveEnergyBurnedXmlCsv
...
if __name__ == '__main__':
    ...
    xml_to_csv(args.xml_filepath, args.csv_filepath,
               ...
               HK_REC_TYPE_ActiveEnergyBurned)
    """

    csv_loader = AppleHealthActiveEnergyBurnedXmlCsv(
